...
class AppCustomAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    //         return new RedirectResponse($this->urlGenerator->generate('app_Alteret_index'));
    //     }
    //     else if("ROLE_USER"){
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        ...
        // if ($this->security->isGranted("ROLE_ADMIN")) {
        //     // Si l'utilisateur a le rôle ADMIN, redirige vers la gestion des Alterets
        //     return new RedirectResponse($this->urlGenerator->generate('app_Alteret_index'));
        // }
        ...
        // return new RedirectResponse($this->urlGenerator->generate('app_default'));
        if ($this->security->isGranted("ROLE_ADMIN")) {
            return new RedirectResponse($this->urlGenerator->generate('app_Alteret_index')); // Remplacez par la route correcte
        }
